...
export default function PatientView({ patientName, patientEmail, onLogout }: PatientViewProps) {
  ...
  const cycleOrderStatus = () => {
    // Allows testing the order states dynamically
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-100 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            {/* Layout Split: Upper Order Progress State */}
      ...
      {/* High-Fidelity Printable Clinical Prescription Modal (PDF Standard View) */}
      {selectedRecipe && (
            ...
            <div className="p-8 space-y-8 flex-1 overflow-y-auto print:overflow-visible bg-white print:p-0">
              ...
              <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs">
                ...
                <div>
                  ...
                  <p className="text-slate-550 mt-1">Validez: Hasta el {selectedRecipe.expiryDate}</p>
                </div>
              </div>
              ...
              {/* Doctor Credentials & Stamp Signature */}
