  ...
  useEffect(() => {
    ...
    const handleConsentResult = async (data: ConsentResultPayload) => {
      ...
      if (data.success) {
        ...
        alert(data.message || 'El paciente deneg? la solicitud de vinculación.');
      }
