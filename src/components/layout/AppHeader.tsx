...
export default function AppHeader({
  ...
  return (
    <header className="border-b border-surface-850 bg-surface-900/95 backdrop-blur-md z-10 shrink-0 px-4 py-2 sm:px-4 sm:py-0 sm:h-16 sm:min-h-16 md:px-6 lg:px-8">
